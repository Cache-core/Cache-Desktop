...
namespace WalletGui
{
  ...
  void OverviewFrame::setStyles(int change)
  {
    ...
    QString tableStyle = "QHeaderView::section{font-size:" + QString::number(baseFontSize) + "px;background-color:#212121;color:#fff;font-weight:700;height:37px;border-top:1px solid #444;border-bottom:1px solid #444}QTreeView::item{color:#ccc;height:37px}";
    QString b1Style = "QPushButton{font-size: " + QString::number(baseLargeButtonSize) + "px; color:#fff;border:1px solid pink;border-radius:5px;} QPushButton:hover{color:pink;}";
    QString b2Style = "QPushButton{font-size: " + QString::number(baseSmallButtonSize) + "px; color: pink; border:1px solid pink; border-radius: 5px} QPushButton:hover{color: gold;}";
  ...
  void OverviewFrame::loadChart()
  {
    ...
    link = ""; // todo "http://walletapi.conceal.network/services/charts/price.png?vsCurrency=" + currency + "&days=30&priceDecimals=2&xPoints=24&width=1170&height=560&dateFormat=MM-DD";
  ...
  void OverviewFrame::actualDepositBalanceUpdated(quint64 _balance)
  {
    ...
    if (walletSynced == true)
    {
      if (unlockedFunds > 0)
      {
        m_ui->m_unlockedDeposits->setStyleSheet("color: pink; background: transparent; font-family: Poppins;  border: none;");
      }
      else
      {
  ...
  void OverviewFrame::onPriceFound(QJsonObject &result)
  {
    ...
    QString cxche = QLocale(QLocale::system()).toString(currency, 'f', 2);
    ...
    m_ui->m_ccx->setText(currentCurrency + " " + cxche);
  ...
  /* Update the total portfolio in CXCHE and Fiat on the top left hand corner */
  void OverviewFrame::updatePortfolio()
  {
    ...
    m_ui->ccxTotal->setText(tr("Total") + " " + CurrencyAdapter::instance().formatAmount(OverviewFrame::totalBalance) + " CXCHE ");
  ...
  void OverviewFrame::bankingClicked()
  {
    ...
    if (walletSynced == true)
    {
      m_ui->m_myCacheWalletTitle->setText(tr("BANKING"));
  ...
  {
    m_ui->darkness->hide();
    m_ui->m_myCacheWalletTitle->setText(tr("TRANSACTIONS"));
  ...
  {
    m_ui->darkness->hide();
    m_ui->m_myCacheWalletTitle->setText(tr("Cache"));
  ...
  {
    m_ui->darkness->hide();
    m_ui->m_myCacheWalletTitle->setText(tr("ABOUT"));
  ...
  {
    m_ui->darkness->hide();
    m_ui->m_myCacheWalletTitle->setText(tr("WALLET SETTINGS"));
  ...
  {
    m_ui->darkness->hide();
    m_ui->m_myCacheWalletTitle->setText(tr("INBOX"));
  ...
  void OverviewFrame::newTransferClicked()
  {
    ...
    if (walletSynced == true)
    {
      m_ui->m_myCacheWalletTitle->setText(tr("SEND FUNDS"));
      ...
      popup->setStyleSheet("background-color: #212121; color: #aaa");
  ...
  void OverviewFrame::newMessageClicked()
  {
    ...
    if (walletSynced == true)
    {
      m_ui->m_myCacheWalletTitle->setText(tr("NEW MESSAGE"));
  ...
  void OverviewFrame::setAddress(const QString &_address)
  {
    ...
    else
    {
      ...
      m_ui->m_myCacheWalletTitle->setText(tr("SEND MESSAGE"));
      m_ui->m_titleIcon->setPixmap(QPixmap(":/icons/icon-send-message"));
      m_ui->newMessageBox->raise();
    }
  }
  ...
  void OverviewFrame::onAddressFound(const QString &_address)
  {
    ...
    if ((!_address.isEmpty()) && (connection != "embedded"))
    {
      ...
      m_ui->m_sendFee->setText("Fee: 0.011000 CXCHE");
      m_ui->m_messageFee->setText("Fee: 0.011000 CXCHE");
      m_ui->m_depositFeeLabel->setText("0.011000 CXCHE");
    }
  }
  ...
  void OverviewFrame::sendFundsClicked()
  {
    ...
    if (address.toStdString().length() == 186)
    {
      ...
      std::string address_string = CryptoNote::getAccountAddressAsStr(CryptoNote::parameters::PUBLIC_ADDRESS_BASE58_PREFIX, addr);
    ...
    try
    {
      ...
      {
        /* Parse the record and set address to the actual CXCHE address */
        std::vector<std::string> records;
        if (!Common::fetch_dns_txt(address.toStdString(), records))
        {
          QCoreApplication::postEvent(&MainWindow::instance(), new ShowMessageEvent(tr("Failed to lookup Cache ID"), QtCriticalMsg));
        }
    ...
    {
      QCoreApplication::postEvent(&MainWindow::instance(), new ShowMessageEvent(tr("Could not check Cache ID"), QtCriticalMsg));
      return;
    }
  ...
  {
    m_ui->m_myCacheWalletTitle->setText(tr("ADDRESS BOOK"));
  ...
  {
    QDesktopServices::openUrl(QUrl("https://discord.gg/PHyGJjg", QUrl::TolerantMode));
  }

  void OverviewFrame::twitterClicked()
  {
    QDesktopServices::openUrl(QUrl("https://twitter.com/Cachecore", QUrl::TolerantMode));
  }
  ...
  {
    QDesktopServices::openUrl(QUrl("https://github.com/cache-core", QUrl::TolerantMode));
  }
